...
# TODO what omegas do we need? Could probably make some thing that generates these and
#  the other relative properties (i.e. whether to use body or hill frame for each sat, what
#  frame to express in)
    ...
    def __init__(
        ...
        Args:
            rel_properties: Property specifications. Properties are optionally
                ...
                * ``prop``: Name of function in :class:`~bsk_rl.obs.relative_observations`.
