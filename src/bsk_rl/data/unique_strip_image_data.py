...
class UniqueStripImageStore(DataStore):
    ...
    def compare_log_states(
        ...
        for idx in update_idx:
            ...
            if data_generated_target > 0.50*t_strip: # The strip is considered as imaged if the data buffer-increase is greater than 95% of the data necessary to store the images from the target strip
