...
class ImagingSCFSWModel(ImagingFSWModel):
    ...
    class LocPointTask(ImagingFSWModel.LocPointTask):
        ...
        def setup_location_pointing(
            ...
            # Initialize with the inspector state; the imaging action rewires this to
            # the selected target state before the instrument is tasked.
        ...
        def setup_instrument_controller(
            ...
            **kwargs,
            ...
            if self.fsw.dynamics.targetLocation.accessOutMsgs:
                # The newest access message corresponds to the currently tasked target.
                self.insControl.locationAccessInMsg.subscribeTo(
