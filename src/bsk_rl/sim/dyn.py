...
class BasicTargetDynamicsModel(BasicDynamicsModel):
    ...
    def setup_simple_nav_object(self, priority: int = 699):
        ...
        self.simpleNavObject = simpleNav.SimpleNav()
        self.simpleNavObject.ModelTag = "SimpleTargetNav"
        self.simpleNavObject.scStateInMsg.subscribeTo(self.scObject.scStateOutMsg)
        self.simulator.AddModelToTask(
            self.task_name, self.simpleNavObject, ModelPriority=priority
        )
...
class ImagingSCDynModel(ImagingDynModel):
    ...
    def setup_metrics(self, use_heuristic: bool, heuristic_mode: str, heuristic_top_k: float, print_info: bool, priority: int = 2000, **kwargs) -> None:
