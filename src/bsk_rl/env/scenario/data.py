...
if TYPE_CHECKING:  # pragma: no cover
    from bsk_rl.env.scenario.environment_features import (
        Target,
    )
...
class DataStore(ABC):
    ...
    def _initialize_knowledge(self, env_features: "EnvironmentFeatures") -> None:
        """Establish knowledge about the world known to the satellite.

        Defaults to knowing everything about the environment.
        """
...
class ScanningNadirTimeStore(DataStore):
    ...
    def _get_log_state(self) -> LogStateType:
        """Return the amount of data stored in the storage unit."""
