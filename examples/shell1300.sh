...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/aug18_restrictedResources_obsv7_5e-6lr_batch640_gradclip0.1_cp0.01_gamma9995_0d100i.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris1300.py
