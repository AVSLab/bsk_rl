...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/oct14_restrictedResources_obsv7_1e-5lr_batch5000_gamma9997_100d00i_reducedFailurePenalty_lowBattPenalty.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris2300.py
