...
if __name__ == "__main__":
    ...
    sat_args["dataStorageCapacity"] = 10 * baseline_storage_bits # bits #times 10 for imaging only
    ...
    run_tag = (
        f"amos2026_LEO_wGAE_BigNetwork_ImagingOnly_00d100i_{batch_size}batch_obsv8_1e-5lr_0.05cp_gradclip0.5_gamma9997"
    )
