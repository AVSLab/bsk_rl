#!/usr/bin/env python3
"""Summarize completed Breckenridge 2x2 Monte Carlo metrics."""
...
def main() -> None:
    ...
    per_seed_path = input_root / "breckenridge2026_2x2_per_seed.csv"
    ...
    summary_path = input_root / "breckenridge2026_2x2_summary.csv"
