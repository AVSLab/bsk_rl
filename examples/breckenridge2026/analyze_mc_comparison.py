...
def inventory_archived_alpha_data(repo_root: Path, output_dir: Path) -> dict:
    archive = repo_root / "examples" / "data" / "archived_alpha_sweep"
    inventory_path = output_dir / "archived_alpha_sweep_inventory.csv"
...
def main() -> None:
    ...
    archived_alpha_data = inventory_archived_alpha_data(repo_root, output_dir)
    ...
    report = {
        ...
        "archived_alpha_data": archived_alpha_data,
