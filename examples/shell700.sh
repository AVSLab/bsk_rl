...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/aug18_restrictedResources_obsv7_5e-7lr_batch320_gamma9995_0d100i.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris700.py
