...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/aug19_justimaging_obsv5_1e-5lr_batch5000_gamma999_0d100i.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris2400.py
