...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/aug19_restrictedResources_obsv7_1e-5lr_batch5000_gamma9997_100d0i.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris2500.py
