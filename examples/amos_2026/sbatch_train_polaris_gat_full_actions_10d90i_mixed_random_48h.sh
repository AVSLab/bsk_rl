...
# catalog-level proportions sampled as LEO=x, MEO=y, GEO=1-x-y.
# Submit from /projects/$USER/bsk_rl with:
#   sbatch examples/amos_2026/sbatch_train_polaris_gat_full_actions_10d90i_mixed_random_48h.sh

#SBATCH --account=ucb550_asc2
#SBATCH --job-name=gat_full_10d90i_mixrand_48h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-10d90i-mixed-random
...
export BSK_RL_REWARD_SPLIT_TAG=10d90iMixedRandom
export BSK_RL_ALPHA_TAG=alpha0p1_mixedRandom
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 10d90i mixed-random 48h + W&B training script"
echo "Target mix sampling: LEO=x~U(0,1), MEO=y~U(0,1-x), GEO=1-x-y"
python3 -u examples/train_Polaris_gat_full_actions_10d90i_mixed_random_wandb.py
