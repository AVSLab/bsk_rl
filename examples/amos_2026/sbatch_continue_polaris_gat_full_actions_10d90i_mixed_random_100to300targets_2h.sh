...
# Two-hour recovery test for the OOM'd 100-300-target mixed 10d90i policy.
...
#SBATCH --job-name=gat_cont_mix_n300_2h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-10d90i-mixed-random-100to300targets-continue2h
...
echo "Testing copied 100-300-target mixed policy restore/training with 200G RAM"
