...
# Two-hour smoke continuation for AMOS 2026 Polaris GAT full-action 10d90i.
...
#SBATCH --job-name=gat_cont_10d90i_2h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-10d90i-continue2h
...
echo "Two-hour smoke continuing copied AMOS 2026 Polaris GAT full-action obs-v9 10d90i policy"
