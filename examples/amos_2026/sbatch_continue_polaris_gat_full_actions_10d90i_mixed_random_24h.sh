...
# Continue the 100-target mixed LEO/MEO/GEO 10d90i policy for 24 hours.
...
#SBATCH --job-name=gat_cont_mixrand_24h
#SBATCH --ntasks=1
...
: "${BSK_RL_CONTINUE_FROM:?Set BSK_RL_CONTINUE_FROM to the original mixed-target run or checkpoint directory.}"
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-10d90i-mixed-random-continue24h
...
echo "Continuing copied 100-target mixed LEO/MEO/GEO policy for 24h"
