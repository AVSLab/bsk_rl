...
export BSK_RL_BATCH_MULTIPLIER=${BSK_RL_BATCH_MULTIPLIER:-32} # cluster override: BSK_RL_BATCH_MULTIPLIER=150 sbatch ...
export BSK_RL_TOTAL_TIMESTEPS=${BSK_RL_TOTAL_TIMESTEPS:-10000} # cluster override: BSK_RL_TOTAL_TIMESTEPS=20000000 sbatch ...
