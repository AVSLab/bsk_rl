...
# 48-hour CURC training job for AMOS 2026 Polaris GAT full-action trainer (80d20i).
# Submit from /projects/$USER/bsk_rl with:
#   sbatch examples/amos_2026/sbatch_train_polaris_gat_full_actions_80d20i_48h.sh

#SBATCH --account=ucb550_asc2
#SBATCH --job-name=gat_full_80d20i_48h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-80d20i
...
export BSK_RL_DOWNLINK_BONUS=0.8
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 80d20i 48h + W&B training script"
python3 -u examples/train_Polaris_gat_full_actions_80d20i_wandb.py
