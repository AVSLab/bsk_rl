...
# 48-hour CURC training job for AMOS 2026 Polaris GAT full-action curriculum trainer.
# Curriculum: 00d100i -> 100d00i over BSK_RL_ALPHA_CURRICULUM_RAMP_STEPS.
# Submit from /projects/$USER/bsk_rl with:
#   sbatch examples/amos_2026/sbatch_train_polaris_gat_full_actions_curriculum_00to100d00i_48h.sh

#SBATCH --account=ucb550_asc2
#SBATCH --job-name=gat_full_cl0to1_48h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-curriculum-00to100d00i
...
export BSK_RL_DOWNLINK_BONUS=0.0
export BSK_RL_ALPHA_CURRICULUM=1
export BSK_RL_ALPHA_CURRICULUM_START=${BSK_RL_ALPHA_CURRICULUM_START:-0.0}
export BSK_RL_ALPHA_CURRICULUM_END=${BSK_RL_ALPHA_CURRICULUM_END:-1.0}
export BSK_RL_ALPHA_CURRICULUM_POWER=${BSK_RL_ALPHA_CURRICULUM_POWER:-1.0}
export BSK_RL_ALPHA_CURRICULUM_RAMP_STEPS=${BSK_RL_ALPHA_CURRICULUM_RAMP_STEPS:-20000000}
export BSK_RL_REWARD_SPLIT_TAG=curriculum00d100iTo100d00i
export BSK_RL_ALPHA_TAG=curriculum0to1
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 curriculum 00d100i->100d00i 48h + W&B training script"
echo "Curriculum ramp steps: $BSK_RL_ALPHA_CURRICULUM_RAMP_STEPS"
python3 -u examples/train_Polaris_gat_full_actions_curriculum_00to100d00i_wandb.py
