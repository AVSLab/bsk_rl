...
#SBATCH --job-name=amos2026_leo_48h
#SBATCH --ntasks=1
...
# These overrides are used by scripts that support env-driven cluster config.
# Older scripts that still hard-code these values will simply ignore them.
