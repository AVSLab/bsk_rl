...
# Two-hour smoke continuation for AMOS 2026 Polaris GAT full-action 20d80i.
...
#SBATCH --job-name=gat_cont_20d80i_2h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-20d80i-continue2h
...
export BSK_RL_DOWNLINK_BONUS=0.2
...
export BSK_RL_TRAIN_TIMEOUT_SEC=${BSK_RL_TRAIN_TIMEOUT_SEC:-5400}
export BSK_RL_CONTINUE_SUFFIX=${BSK_RL_CONTINUE_SUFFIX:-continue2h_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID:-0}}
...
echo "Two-hour smoke continuing copied AMOS 2026 Polaris GAT full-action obs-v9 20d80i policy"
python3 -u examples/train_Polaris_gat_full_actions_20d80i_wandb.py
