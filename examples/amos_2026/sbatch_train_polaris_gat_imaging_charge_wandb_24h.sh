...
# 24-hour CURC training job for the AMOS 2026 Polaris GAT imaging+charge trainer.
...
#SBATCH --job-name=polaris_gat_ic_24h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=${BSK_RL_WANDB_GROUP:-polaris-gat-imaging-charge-obs-v9-24h}
...
echo "Running AMOS 2026 Polaris GAT imaging+charge obs-v9 + W&B training script"
python3 -u examples/train_Polaris_gat_imaging_charge_wandb.py
