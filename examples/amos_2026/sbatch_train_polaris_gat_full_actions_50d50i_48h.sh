...
# 48-hour CURC training job for AMOS 2026 Polaris GAT full-action trainer (50d50i).
# Submit from /projects/$USER/bsk_rl with:
#   sbatch examples/amos_2026/sbatch_train_polaris_gat_full_actions_50d50i_48h.sh

#SBATCH --account=ucb550_asc2
#SBATCH --job-name=gat_full_50d50i_48h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-50d50i
