...
# Continue an existing AMOS 2026 Polaris GAT full-action 20d80i policy for 24h.
...
#SBATCH --job-name=gat_cont_20d80i_24h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-20d80i-continue24h
...
echo "Continuing copied AMOS 2026 Polaris GAT full-action obs-v9 20d80i policy"
