...
# 24-hour CURC training job for AMOS 2026 Polaris GAT full-action trainer (20d80i).
...
#SBATCH --job-name=gat_full_a0p2_24h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-alpha0p2
...
export BSK_RL_ALPHA_TAG=alpha0p2
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 20d80i + W&B training script"
python3 -u examples/train_Polaris_gat_full_actions_alpha0p2_wandb.py
