...
# 24-hour CURC training job for the AMOS 2026 Polaris Target-GNN + W&B trainer.
...
#SBATCH --job-name=polaris_tgn_24h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=${BSK_RL_WANDB_GROUP:-polaris-target-gnn-obsB8-24h}
...
echo "Running AMOS 2026 Polaris Target-GNN obsB8 + W&B training script"
