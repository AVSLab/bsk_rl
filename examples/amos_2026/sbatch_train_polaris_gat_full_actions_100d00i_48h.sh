...
# 48-hour CURC training job for AMOS 2026 Polaris GAT full-action trainer (100d00i).
# Submit from /projects/$USER/bsk_rl with:
#   sbatch examples/amos_2026/sbatch_train_polaris_gat_full_actions_100d00i_48h.sh

#SBATCH --account=ucb550_asc2
#SBATCH --job-name=gat_full_100d00i_48h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-100d00i
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 100d00i 48h + W&B training script"
srun --ntasks=1 --cpus-per-task="${SLURM_CPUS_PER_TASK:-32}" --acctg-freq=task=30 \
    python3 -u examples/train_Polaris_gat_full_actions_100d00i_wandb.py
