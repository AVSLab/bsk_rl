...
# 48-hour CURC training job for AMOS 2026 Polaris GAT full-action trainer (20d80i).
...
#SBATCH --job-name=gat_full_20d80i_48h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-20d80i
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 20d80i 48h + W&B training script"
