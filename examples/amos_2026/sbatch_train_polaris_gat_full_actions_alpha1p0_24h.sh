...
# 24-hour CURC training job for AMOS 2026 Polaris GAT full-action trainer (100d00i).
# Submit from /projects/$USER/bsk_rl with:
#   sbatch examples/amos_2026/sbatch_train_polaris_gat_full_actions_alpha1p0_24h.sh

#SBATCH --account=ucb550_asc2
#SBATCH --job-name=gat_full_a1p0_24h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-alpha1p0
...
export BSK_RL_ALPHA_TAG=alpha1p0
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 100d00i + W&B training script"
python3 -u examples/train_Polaris_gat_full_actions_alpha1p0_wandb.py
