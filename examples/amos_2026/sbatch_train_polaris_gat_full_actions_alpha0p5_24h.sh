...
# 24-hour CURC training job for AMOS 2026 Polaris GAT full-action trainer (50d50i).
# Submit from /projects/$USER/bsk_rl with:
#   sbatch examples/amos_2026/sbatch_train_polaris_gat_full_actions_alpha0p5_24h.sh

#SBATCH --account=ucb550_asc2
#SBATCH --job-name=gat_full_a0p5_24h
#SBATCH --ntasks=1
...
export BSK_RL_WANDB_GROUP=polaris-gat-full-actions-obs-v9-alpha0p5
...
export BSK_RL_DOWNLINK_BONUS=0.5
export BSK_RL_ALPHA_TAG=alpha0p5
...
echo "Running AMOS 2026 Polaris GAT full-action obs-v9 50d50i + W&B training script"
python3 -u examples/train_Polaris_gat_full_actions_alpha0p5_wandb.py
