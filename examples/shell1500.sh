...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/oct14_restrictedResources_obsv7_1e-5lr_batch10k_gamma9997_50d50i_reducedFailurePenalty.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris1500.py
