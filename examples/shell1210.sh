...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/aug18_restrictedResources_obsv7_1e-7lr_batch1600_gradclip0.1_cp0.01_gamma9995_0d100i.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris1210.py
