...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/aug18_restrictedResources_obsv7_1e-6lr_batch3200_gamma997_0d100i.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris1700.py
