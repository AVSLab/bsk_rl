...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/jan26_restrictedResources_obsv7_1e-5lr_batch4200_gamma9997_0d100i.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris100.py
