...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/july29_policy_evaluation_test2.out
#SBATCH --qos=normal
...
python3 /projects/$USER/bsk_rl/examples/cluster_policy_evaluation.py
