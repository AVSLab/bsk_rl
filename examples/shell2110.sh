...
#SBATCH --nodes=1
#SBATCH --output=/scratch/alpine/%u/job_output/oct14_restrictedResources_obsv7_1e-5lr_batch5000_gamma9997_10d90i_reducedFailurePenalty_lowBatPenalty.out
...
python3 /projects/$USER/bsk_rl/examples/train_Polaris2110.py
