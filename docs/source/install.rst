...
#. Test the installation by running the unit tests and integration tests.
   ...
   This JAS snapshot intentionally omits the broader examples gallery. After installing
   the RLlib dependencies, the paper evaluator can be checked with
   ``python examples/Huterer_JAS/eval_amos2025_jas.py --help``.
