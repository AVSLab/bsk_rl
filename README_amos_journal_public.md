# AMOS Journal Public Snapshot

This branch preserves a public reference point for the AMOS journal work based on the late-September 2025 research state.
...
This keeps the AMOS-era Polaris training, evaluation, and analysis scripts close to the state used during the August and September 2025 research push, while cleaning up informal comments and adding a short guide for outside users.
